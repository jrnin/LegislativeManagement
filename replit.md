...
- **File Management**: Complete Object Storage integration with organized directory structure (/documents/YYYY/MM), SimpleFileUploader component replacing Uppy, presigned URL uploads, ACL policy management, seamless document creation workflow, comprehensive document details page with embedded PDF viewer, and conservative file update approach that preserves existing files during edits unless new uploads are made (August 2025).

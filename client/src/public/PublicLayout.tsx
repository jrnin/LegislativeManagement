...
export default function PublicLayout({ children }: PublicLayoutProps) {
  ...
  return (
    <div className={`min-h-screen flex flex-col ${isDarkMode ? 'dark bg-slate-900 text-white' : 'bg-white'} ${isHighContrast ? 'high-contrast' : ''}`}>
      ...
      {/* Componentes fixos fora do header - alinhados à margem do layout */}
      <div className="hidden lg:block fixed top-32 right-0 z-40 max-w-7xl mx-auto w-full px-4">
        <div className="flex justify-end">
          <div className={`flex items-center space-x-3 transition-transform duration-300 ease-in-out ${

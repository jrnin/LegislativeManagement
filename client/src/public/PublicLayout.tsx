          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="flex justify-between items-center">
              ...
              <div className="hidden lg:flex flex-1 justify-center mx-8">
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border border-green-200/50 dark:border-green-700/50 rounded-xl px-4 py-2 shadow-sm hover:shadow-md transition-all duration-300 max-w-md">
                        ...
                        <Link href="/eventos">
                          <div className="cursor-pointer group">
                            ...
                            <p className="text-xs text-green-600 dark:text-green-400 mt-1">
                              {(latestEvent as any).date} • {(latestEvent as any).time}
                            </p>
                          </div>
                        </Link>
                      ) : (

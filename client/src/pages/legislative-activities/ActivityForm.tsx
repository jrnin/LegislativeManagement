...
export default function ActivityForm() {
  ...
  const updateMutation = useMutation({
    mutationFn: async (data: any) => {
      ...
      // Append Object Storage file info ONLY if new file was uploaded
      console.log(`[DEBUG] Checking file upload state:`, { 
        uploadedFileURL, 
        uploadedFileName, 
        formFile,
        hasURL: !!uploadedFileURL,
        urlTrimmed: uploadedFileURL?.trim(),
  ...
  const onSubmit = (data: FormData) => {
    ...
    console.log(`[DEBUG] uploadedFileURL:`, uploadedFileURL);
    console.log(`[DEBUG] uploadedFileName:`, uploadedFileName);
    console.log(`[DEBUG] formFile:`, formFile);
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="grid grid-cols-1 gap-4">
                <div>
                  ...
                  <div className="mt-2">
                    <SimpleFileUploader
                      onUploadComplete={(uploadedFileURL: string, fileName: string, file?: File) => {
                        setUploadedFileURL(uploadedFileURL);
                        setUploadedFileName(fileName);
                        if (file) {
                          setFormFile(file);
                        }
                        console.log("File uploaded successfully:", { uploadedFileURL, fileName, file: !!file });
                        console.log("State updated - uploadedFileURL:", uploadedFileURL);
                        console.log("State updated - uploadedFileName:", fileName);
                        console.log("State updated - formFile:", !!file);
                      }}
